...
import {login, register1} from "backend/idm";
 ...
 * refreshToken given to use when the user calls "register".
 * <br>
...
const Register = () => {
    ...
    return (
        <StyledDiv>
            ...
            <StyledDivTextbox>
                <StyledButton onClick={handleSubmit(submitRegister)}><b>Register</b></StyledButton>
                <StyledNotAUser onClick={handleSubmit(goToLogin)}><b>Already a User?</b></StyledNotAUser>
            </StyledDivTextbox>
        </StyledDiv>
    );
}
